...
<div class="row">
    <div class="col-lg-12 form-length">
        ...
        <form method="post" action="/contactform_style_buttondelete/save.php<?= $saveAttr ?>" class="text-center">
            ...
            <a href="/contactform_style_buttondelete" class="btn btn-danger">Cancel</a>
        </form>
...
<?php foreach ($comments as $comment) : ?>
    ...
    <div class="row">
        <div class="col-lg-12 comments">
            ...
            <a href="/contactform_style_buttondelete/?file=<?= $comment['file'] ?>" class="btn btn-xs btn-info">Edit</a>
            <a href="/contactform_style_buttondelete/delete.php?file=<?= $comment['file'] ?>" class="btn btn-xs btn-danger">Delete</a>
        </div>
    </div>
